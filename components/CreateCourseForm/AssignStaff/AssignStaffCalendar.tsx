...
import EventsItem from "../AddLecture/EventsItem";
import ControlledEventSchedular from "../../EventSchedular/ControlledEventSchedular";
...
const AssignStaffCalendar: FunctionComponent<IProps> = ({
  handleBack,
  handleNext,
}) => {
...
export default AssignStaffCalendar;
