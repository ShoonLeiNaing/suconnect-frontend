      ...
      >
        <Box className="flex flex-col gap-2">
          ...
          <Box className="flex items-center justify-between gap-2">
            <NumberInput value={startHour} setValue={setStartHour} />
            <Typography>:</Typography>
            <NumberInput value={startMin} setValue={setStartMin} />
            <AMPMInput />
          </Box>
        </Box>
        <Box className="flex flex-col gap-2">
          ...
          <Box className="flex items-center justify-between gap-2">
            <NumberInput value={endHour} setValue={setEndHour} />
            <Typography>:</Typography>
            <NumberInput value={endMin} setValue={setEndMin} />
            <AMPMInput />
          </Box>
        </Box>
      </Box>
