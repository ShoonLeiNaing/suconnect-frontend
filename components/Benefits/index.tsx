...
const Benefit: FunctionComponent = () => {
    return (
        <Box marginBottom="4rem">
            ...
            />
            <Tagline 
                text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit ac ultrices nunc commodo nunc consequat."
            />
            <Box margin="auto" display="flex" gap={6} mt={8}>
                ...
                />
                <Card
                    icon="/images/benefit5.svg"
                    title="Flexibility"
                />
                <Card
                    icon="/images/benefit6.svg"
                    title="Track Easily"
                />
                <Card
                    icon="/images/benefit7.svg"
                    title="Reduce Time"
                />
            </Box>
        </Box>
