...
import { Box, InputBase, SelectChangeEvent, styled, AccordionDetails, FormControl, Select, MenuItem } from '@mui/material';
...
const AccordionEditComponent : FunctionComponent= ( ) => {
  ...
  return (
    <Box>
        <AccordionDetails className='flex-col bg-white rounded-b-2xl'>
          <Box className='flex justify-between px-6'>
            <Box className='flex flex-col'>
                  <Box className='mt-4'>
                      <InputLabel label="House Number" />
                      <DynamicInput value={houseNo} setValue={setHouseNo} maxWidth="300px" />
                  </Box>
                  <Box className='my-4'>
              ...
              <Box className='flex flex-col mx-12'>
                  <Box className='mt-4'>
                      ...
                      <DynamicInput value={street} setValue={setStreet} maxWidth="300px" />
                  </Box>
                  <Box className='my-4'>
              ...
              <Box className='flex flex-col'>
                  <Box className='mt-4'>
                      ...
                      <DynamicInput value={township} setValue={setTownship} maxWidth="300px" />
                  </Box>
                  <Box className='my-4'>
                      <InputLabel label="Postal Code" />
                      <DynamicInput value={postalCode} setValue={setPostalCode} maxWidth="300px" />
                  </Box>
              </Box>
          </Box>
