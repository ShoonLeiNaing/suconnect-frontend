...
const Login: FunctionComponent = () => {
  ...
  return (
    <Box className="h-screen flex justify-center items-center">
      <Box className="hidden md:flex justify-center items-center bg-[#F6F9FE] h-screen w-1/2">
        <Image src="/images/login.svg" height={450} width={450} />
      </Box>
      <Box className="flex flex-col justify-center items-center bg-white w-full lg:w-1/2 px-6 sm:px-8 md:px-12 xl:px-24 max-w-[550px] xl:max-w-full">
        ...
        <Box className="w-full flex flex-col border py-8 px-8 md:px-10 rounded-xl">
          <Box className="mb-6">
