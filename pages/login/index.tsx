...
const Login: FunctionComponent = () => {
  ...
  return (
    <Box className="h-screen flex justify-center items-center">
      <Box
        width={{ xl: "40%", lg: "40%", md: "30%", sm: "100%" }}
        flex={1}
        className="hidden md:flex  justify-center items-center md:bg-[#F6F9FE] h-screen w-full py-4"
      >
        <Box
          height={{ xl: "300px", sm: "250px", base: "100px" }}
          width={{ xl: "300px", sm: "250px", base: "100px" }}
        >
      ...
      <Box
        flex={1}
        className="flex flex-col justify-center items-center bg-white px-4 sm:px-8 md:px-6 lg:px-20"
      >
        <Box width={{ lg: "500px", md: "430px", sm: "370px", xs: "360px" }}>
          <Box className="w-full flex items-center mb-0 sm:mb-2 md:mb-8 -mt-12 ">
            ...
            {/* <Box className="flex sm:hidden mr-4">
              <select
                className="select"
                value={language}
          ...
          <Typography className="my-6 text-[1.15rem] sm:text-[1.3rem] text-[#737373] font-semibold w-full">
            Login to dashboard
          </Typography>
          <Box className="w-full flex flex-col border py-8 px-6 md:px-10 rounded-xl">
            <Box className="mb-6">
          ...
          <Box className="w-full flex justify-between items-center mt-8">
            <Typography className="text-[#737373] text-sm sm:text-base">
              If you have no account,{" "}
              <Link href="/signup">
                <a className="text-[#3B8CF7]">sign up here.</a>
              </Link>
            </Typography>
            <SmallButton
              text="Login"
          ...
          <Box className="w-full flex justify-between items-center mb-4 mt-16 md:mt-20 lg:mt-32 ">
